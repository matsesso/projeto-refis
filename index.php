        ...
        <div class="container">
         <div class="row">
             <div class="col-lg-8 col-lg-offset-2">
                 <h2 style="color:#8D0F12;" class="display-1 text-center">REFIS</h2>
             </div>
                        <div class="card-body col-lg-8 col-lg-offset-2 mr-5 pl-5">
                         <h2 style="color: black;" class="card-title mb-4">Prezado(a) profissional,</h2>
                        <hr>
                         <h2 id="info" class="card-text text-justify">Para gerar os boletos relativos à sua anuidade é necessário informar alguns dados obrigatórios. Para iniciar selecione o estado do Conselho Regional (<span style="color:#8E0F12;">CRO</span>):
                         </div>                    
                        <div class="col-lg-8 col-lg-offset-2">
                        <div class="hidden-xs" style="margin-top:20px;" align="center">
                        <svg version="1.1" id="svg-map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="450px" height="460px" viewBox="0 0 450 460" enable-background="new 0 0 450 460" xml:space="preserve">
                            <g>
                                <a xlink:href="redirect.php?cro=TO">
                                ...
                                <a xlink:href="redirect.php?cro=BA">
                                    <title>Bahia</title>
                                ...
                                <a xlink:href="redirect.php?cro=SE">
                                    <title>Sergipe</title>
                                ...
                                <a xlink:href="redirect.php?cro=PE">
                                ...
                                <a xlink:href="redirect.php?cro=AL">
                                    <title>Alagoas</title>
                                ...
                                <a xlink:href="redirect.php?cro=RN">
                                ...
                                <a xlink:href="redirect.php?cro=CE">
                                    <title>Ceará</title>
                                ...
                                <a xlink:href="redirect.php?cro=PI">
                                    <title>Piauí</title>
                                ...
                                <a xlink:href="redirect.php?cro=MA">
                                ...
                                <a xlink:href="redirect.php?cro=AP">
                                    <title>Amapá</title>
                                ...
                                <a xlink:href="redirect.php?cro=PA">
                                    <title>Pará</title>
                                ...
                                <a xlink:href="redirect.php?cro=RR">
                                    <title>Roraima</title>
                                ...
                                <a xlink:href="redirect.php?cro=AM">
                                ...
                                <a xlink:href="redirect.php?cro=AC">
                                    <title>Acre</title>
                                ...
                                </a><a xlink:href="redirect.php?cro=RO">
                                ...
                                <a xlink:href="redirect.php?cro=MT">
                                ...
                                <a xlink:href="redirect.php?cro=MS">
                                ...
                                <a xlink:href="redirect.php?cro=GO">
                                    <title>Goiás</title>
                                ...
                                <a xlink:href="redirect.php?cro=PR">
                                    <title>Paraná</title>
                                ...
                                <a xlink:href="redirect.php?cro=SC">
                                ...
                                <a xlink:href="redirect.php?cro=RS">
                                ...
                                <a xlink:href="redirect.php?cro=SP">
                                ...
                                <a xlink:href="redirect.php?cro=MG">
                                ...
                                <a xlink:href="redirect.php?cro=RJ">
                                ...
                                <a xlink:href="redirect.php?cro=ES">
                                ...
                                <a xlink:href="redirect.php?cro=DF">
                                ...
                                <a xlink:href="redirect.php?cro=PB">
                                    <title>Paraíba</title>
                ...
                <div class="visible-xs" style="margin-top:20px;margin-bottom:70px;" align="center">
